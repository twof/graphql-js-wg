...
- **Date & Time**: [April 27 2022 17:00 - 18:00 UTC](https://www.timeanddate.com/worldclock/meetingdetails.html?year=2022&month=04&day=27&hour=17&min=0&sec=0&p1=224&p2=179&p3=136&p4=37&p5=239&p6=101&p7=152)
- **Calendar**:
...
1. [Scalar access to context](https://github.com/graphql/graphql-js/issues/3539) (5m, Saihaj)
1. [Validation rules mismatch](https://github.com/graphql/graphql-js/issues/3286) (5m, Saihaj)
1. Schema first approach with `graphql-js` (5m, Saihaj)
   1. [`addResolversToSchema`](https://github.com/ardatan/graphql-tools/blob/master/packages/schema/src/addResolversToSchema.ts)
1. Status of CCN PR (5m, Alex)
2. ADD YOUR ACTION ITEMS ABOVE_
